    ...
    for tr in tr_elements:
        ...
        if td.has_attr('colspan'): # its a sub header
            ...
            if td.findAll('a'): # true if the list is longer than one, in our case it will either be len of 0 or 1
                ...
                current_contexts['linked_context']['context'] = trim(link[0])
...
def create_references(table): # could just go by td elements instead
    ...
    for td in td_elements:
        if td.has_attr('colspan'):  # sub header
            ...
            sentences = td.text.split('\xa0')
            sentences = list(map(lambda sentence: trim(sentence), sentences))
            if len(find_occurances(td.text,'\xa0')) == 2:
...
,parse_html('<html>\n\n<head>\n<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>\n<LINK href="style.css" rel="stylesheet" type="text/css">\n<script type="text/javascript">function cFunc(val){top.frames["synonym"].location=\'synonym.php?search=\'+val;top.frames["similar"].location=\'similar.php?search=\'+val;top.frames["result"].location=\'detail.php?search=\'+val;}</script>\n</head>\n\n<BODY topmargin=1 LEFTMARGIN=1 rigntmargin="1">\n\n<TABLE WIDTH=100%>\n<TR><TD COLSPAN=3>\n<center><sup><font size=+1></font></sup><font size=+3><b>-ಅ<img src=images/EBig.JPG />o<img src=images/E.JPG width=0 />ಟ&nbsp;&nbsp;\n    -ụṇṭa    </center></b></font><br> </TD>\n</TR>\n\n<TR><TD COLSPAN=3><center>&nbsp;Southern dialects. &nbsp;&nbsp;</center></TD></TR></TABLE><br><font size=-1><TABLE WIDTH=100%><TR><TD COLSPAN=3 class=tblhead><b>MEANINGS</b></TD></TR><TR><TD colspan=3><b><i>Suffix</i></b></TD></TR><TR><TD valign=top></TD><TD valign=top>ಕ್ರಿಯಾರೂಪಗಳಿಗೆ \'-ಅರೆ\' ಎಂಬರ್ಥ ಕೊಡುವ ಸಾಪೇಕ್ಷರೂಪ ನಿಷ್ಪತ್ತಿಗಾಗಿ ಸೇರುವ ಪ್ರತ್ಯಯದ ರೂಪಭೇದ</TD><TD valign=top>The conditional suffix added to verbal forms</TD></TR>      </TABLE><br><TABLE WIDTH=100%><TR><TD COLSPAN=3 class=tblhead><b>VARIATIONS (Region/Caste wise)</b></TD></TR><TR><TD>&nbsp;</TD><TD COLSPAN=2><b><i>Northen Dialects</i></b></TD></TR><TD>&nbsp;</TD><TD>&nbsp;</TD><TD>                <sup><font size=-2>1</font></sup>                <a href=\'javascript:cFunc("10000000010");\'>\n                -ಡ</a>\n                &nbsp;(-ḍa).&nbsp;&nbsp;                <sup><font size=-2>9</font></sup>                <a href=\'javascript:cFunc("10000000011");\'>\n                -ಅ</a>\n                &nbsp;(-a).&nbsp;&nbsp;                                <a href=\'javascript:cFunc("1000000007");\'>\n                -ಅ<img src=images/E.JPG height=13 width=10 BoRDER=0 />o<img src=images/E.JPG height=0 width=0 BORDER=0 />ಡ</a>\n                &nbsp;(-ụṇḍa).&nbsp;&nbsp;                                <a href=\'javascript:cFunc("1000000008");\'>\n                -ಅಂಡ</a>\n                &nbsp;(-aṇḍa).&nbsp;&nbsp;                <sup><font size=-2>2</font></sup>                <a href=\'javascript:cFunc("1000000009");\'>\n                -ಆಂಡ</a>\n                &nbsp;(-aaṇḍa).&nbsp;&nbsp;</TD></TR><TR><TD>&nbsp;</TD><TD COLSPAN=2><b><i>Southern dialects</i></b></TD></TR><TD>&nbsp;</TD><TD>&nbsp;</TD><TD>                                <a href=\'javascript:cFunc("10000000013");\'>\n                -ಅಂಟ</a>\n                &nbsp;(-aṇṭa).&nbsp;&nbsp;                <sup><font size=-2>1</font></sup>                <a href=\'javascript:cFunc("10000000014");\'>\n                -ಟ</a>\n                &nbsp;(-ṭa).&nbsp;&nbsp;<br/></TD></TR></TABLE><br><TABLE WIDTH=100%><TR><TD COLSPAN=3 class=tblhead><b>EXAMPLES</b></TD></TR><TR><TD><i><b></TD><TD COLSPAN=2>battụṇḍa, battụṇṭa if one comes; biisiyaaṇḍa, biisiyaḍa, biisiyaṇḍa if (you) grind<br/></TD></TR></TABLE><br></BODY>\n</html>')
...
,parse_html('<html>\n\n<head>\n<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>\n<LINK href="style.css" rel="stylesheet" type="text/css">\n<script type="text/javascript">function cFunc(val){top.frames["synonym"].location=\'synonym.php?search=\'+val;top.frames["similar"].location=\'similar.php?search=\'+val;top.frames["result"].location=\'detail.php?search=\'+val;}</script>\n</head>\n\n<BODY topmargin=1 LEFTMARGIN=1 rigntmargin="1">\n\n<TABLE WIDTH=100%>\n<TR><TD COLSPAN=3>\n<center><sup><font size=+1>1</font></sup><font size=+3><b>-ಅ<img src=images/EBig.JPG />o<img src=images/E.JPG width=0 />ಡ್&nbsp;&nbsp;\n    -ụṇḍụ    </center></b></font><br> </TD>\n</TR>\n\n<TR><TD COLSPAN=3><center>&nbsp;Common Harijan Tribal Jain. &nbsp;&nbsp;</center></TD></TR></TABLE><br><font size=-1><TABLE WIDTH=100%><TR><TD COLSPAN=3 class=tblhead><b>MEANINGS</b></TD></TR><TR><TD colspan=3><b><i>Suffix</i></b></TD></TR><TR><TD valign=top></TD><TD valign=top>ಭೂತಕಾಲರೂಪದಲ್ಲಿ ಪ್ರಧಮ ಪುರುಷ ನಪುಂಸಕ ಏಕವಚನ ಸೂಚಕ ಪ್ರತ್ಯಯ</TD><TD valign=top>The third person neuter singular suffix in the past tense</TD></TR>      </TABLE><br><TABLE WIDTH=100%><TR><TD COLSPAN=3 class=tblhead><b>VARIATIONS (Region/Caste wise)</b></TD></TR><TR><TD>&nbsp;</TD><TD COLSPAN=2><b><i>Common Harijan Tribal Jain</i></b></TD></TR><TD>&nbsp;</TD><TD>&nbsp;</TD><TD>                <sup><font size=-2>1</font></sup>                <a href=\'javascript:cFunc("1000000005");\'>\n                -ಇಂಡ್</a>\n                &nbsp;(-iṇḍụ).&nbsp;&nbsp;                <sup><font size=-2>3</font></sup>                <a href=\'javascript:cFunc("1000000006");\'>\n                -ಉಂಡು</a>\n                &nbsp;(-uṇḍu).&nbsp;&nbsp;<br/></TD></TR></TABLE><br><TABLE WIDTH=100%><TR><TD COLSPAN=3 class=tblhead><b>EXAMPLES</b></TD></TR><TR><TD><i><b></TD><TD COLSPAN=2>battụṇḍụ (it) came; pooṇḍu (it) went; kaḍiṇḍụ (it) broke, etc<br/></TD></TR></TABLE><br></BODY>\n</html>')
,parse_html('<html>\n\n<head>\n<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>\n<LINK href="style.css" rel="stylesheet" type="text/css">\n<script type="text/javascript">function cFunc(val){top.frames["synonym"].location=\'synonym.php?search=\'+val;top.frames["similar"].location=\'similar.php?search=\'+val;top.frames["result"].location=\'detail.php?search=\'+val;}</script>\n</head>\n\n<BODY topmargin=1 LEFTMARGIN=1 rigntmargin="1">\n\n<TABLE WIDTH=100%>\n<TR><TD COLSPAN=3>\n<center><sup><font size=+1></font></sup><font size=+3><b>ಅ<img src=images/EBig.JPG /><img src=images/LBig.JPG width=15 height=25/>&nbsp;&nbsp;\n    ụụ    </center></b></font><br> </TD>\n</TR>\n\n<TR><TD COLSPAN=3><center>&nbsp;&nbsp;</center></TD></TR></TABLE><br><font size=-1><TABLE WIDTH=100%><TR><TD COLSPAN=3 class=tblhead><b>MEANINGS</b></TD></TR><TR><TD colspan=3><b><i> </i></b></TD></TR><TR><TD valign=top></TD><TD valign=top>ತುಳು ವರ್ಣಮಾಲೆಯ ಅಕ್ಷರದ ಧೀರ್ಘರೂಪ ತುಳು \'ಭಾಗವತೊ\'ದಲ್ಲಿ ಹಾಗೂ \'ಕಾವೇರಿ\'ಯಲ್ಲಿ ಕೆಲವೆಡೆ ಪದಾಂತ್ಯದಲ್ಲಿ ಕಂಡು ಬರುತ್ತದೆ</TD><TD valign=top>The lenthened form of the vowel ụ found in the final position in some words in Bhagavato and Kaveri</TD></TR>      </TABLE><br><TABLE WIDTH=100%><TR><TD COLSPAN=3 class=tblhead><b>REFERENCES</b></TD></TR><TR><TD>&nbsp;&nbsp;</TD><TD COLSPAN=2><i><b>Bhagavato.(1.3.23,250)</TD></TR><TD>&nbsp;&nbsp;</TD><TD>&nbsp;&nbsp;</TD><TD>ಉರೆಸ್ಟ್ ಪುಗೆಸ್ಟೇ ಕಿಡಿಕೀತ್<img src=images/E.JPG width=0 />ಸ್ಟ್<img src=images/E.JPG width=0 />ತ್ ಜ್ವಾಲೇ ಪಿದೆಯಾಸ್ಟ್.&nbsp;uresṭụụ pugesṭụụkiḍikiitụsṭụtụụ jvaalee pideyaasṭụ.&nbsp;ಘರ್ಷಣೆಗೊಂಡು ಹೊಗೆತು ಕಿಡಿಯೆದ್ದು ಜ್ವಾಲೆ ಹೊರಟು.<br></TD></TR></TABLE><br></BODY>\n</html>')
,parse_html('<html>\n\n<head>\n<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>\n<LINK href="style.css" rel="stylesheet" type="text/css">\n<script type="text/javascript">function cFunc(val){top.frames["synonym"].location=\'synonym.php?search=\'+val;top.frames["similar"].location=\'similar.php?search=\'+val;top.frames["result"].location=\'detail.php?search=\'+val;}</script>\n</head>\n\n<BODY topmargin=1 LEFTMARGIN=1 rigntmargin="1">\n\n<TABLE WIDTH=100%>\n<TR><TD COLSPAN=3>\n<center><sup><font size=+1></font></sup><font size=+3><b>ಅಂಧತೆ&nbsp;&nbsp;\n    andhate    </center></b></font><br> </TD>\n</TR>\n\n<TR><TD COLSPAN=3><center>&nbsp;Srii Bhagavato (Ed. Venktataraja Puninchattaya). &nbsp;&nbsp;</center></TD></TR></TABLE><br><font size=-1><TABLE WIDTH=100%><TR><TD COLSPAN=3 class=tblhead><b>MEANINGS</b></TD></TR><TR><TD colspan=3><b><i>Noun</i></b></TD></TR><TR><TD valign=top></TD><TD valign=top>ಕುರುಡುತನ;ಅಜ್ಞಾನ</TD><TD valign=top>Blindness Ignorance</TD></TR>      </TABLE><br><TABLE WIDTH=100%><TR><TD COLSPAN=3 class=tblhead><b>REFERENCES</b></TD></TR><TR><TD>&nbsp;&nbsp;</TD><TD COLSPAN=2><i><b>Bhagavato. (3.8.27, 274)</TD></TR><TD>&nbsp;&nbsp;</TD><TD>&nbsp;&nbsp;</TD><TD>ಅಪ್ಪನಂಧತೆ ಖಂಡಿತೆರ್ಕಪಿಲಾನ್ಕೆಲಾ.&nbsp;appanandhate khaṇḍiterkapilaankelaa.&nbsp;ಕಪಿಲರು\xa0ತಾಯಿಯ\xa0ಅಜ್ಞಾನವನ್ನು\xa0ಹೋಗಲಾಡಿಸಿದರು<br></TD></TR></TABLE><br><TABLE WIDTH=100%><TR><TD COLSPAN=3 class=tblhead><b>Language References</b></TD></TR><TR><TD><i><b></TD><TD COLSPAN=2>Skt. andhataa.<br/></TD></TR></TABLE><br></BODY>\n</html>')
,parse_html('<html>\n\n<head>\n<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>\n<LINK href="style.css" rel="stylesheet" type="text/css">\n<script type="text/javascript">function cFunc(val){top.frames["synonym"].location=\'synonym.php?search=\'+val;top.frames["similar"].location=\'similar.php?search=\'+val;top.frames["result"].location=\'detail.php?search=\'+val;}</script>\n</head>\n\n<BODY topmargin=1 LEFTMARGIN=1 rigntmargin="1">\n\n<TABLE WIDTH=100%>\n<TR><TD COLSPAN=3>\n<center><sup><font size=+1></font></sup><font size=+3><b>ಬೊಲ್ಲಿದಲ ಗಿಡಿಯೇ ಆದ್ ಗಿಲಿನೊಂಜಾ ಮುಟ್ಟರೆ ಪೋತೆರಾರ್ ಸಿರಿ ಕೃಷ್ಣಲ್ಲ ದೇವೆರ್&nbsp;&nbsp;\n    bollidala giḍiyee\xa0 aadụ gilinoñjaa muṭṭare pooteraarụ siri kṛṣṇalla deeverụ    </center></b></font><br> </TD>\n</TR>\n\n<TR><TD COLSPAN=3><center>&nbsp;Paaddana, Tulu folk literature. &nbsp;&nbsp;</center></TD></TR></TABLE><br><font size=-1><TABLE WIDTH=100%><TR><TD COLSPAN=3 class=tblhead><b>MEANINGS</b></TD></TR><TR><TD colspan=3><b><i> </i></b></TD></TR><TR><TD valign=top></TD><TD valign=top>ಬೆಳ್ಳಿಯ ಗಿಡುಗನಾಗಿ ಗಿಳಿಯನ್ನು ಮುಟ್ಟಲಿಕ್ಕೆ ಹೋದರು ಶ್ರೀ ಕೃಷ್ಣ ದೇವರು</TD></TR>      </TABLE><br></BODY>\n</html>')
]
print(correct_unicode('-ಅ್oಡ'))
# # for word in words:
